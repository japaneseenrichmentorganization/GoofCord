...
import { setAutostart as ___modules_autostart_setAutostart } from "../modules/autostart";
...
export function registerAllHandlers() {
  ...
  ipcMain.handle("autostart:setAutostart", async (event) => { return await ___modules_autostart_setAutostart(); });
